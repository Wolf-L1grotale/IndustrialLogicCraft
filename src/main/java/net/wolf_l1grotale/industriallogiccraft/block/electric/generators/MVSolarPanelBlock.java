...
public class MVSolarPanelBlock extends BaseBlockWithEntity {
    public static final MapCodec<MVSolarPanelBlock> CODEC =
            MVSolarPanelBlock.createCodec(MVSolarPanelBlock::new);


    protected MVSolarPanelBlock(Settings settings) {
