...
public class HVSolarPanelBlock extends BaseBlockWithEntity {
    public static final MapCodec<HVSolarPanelBlock> CODEC =
            HVSolarPanelBlock.createCodec(HVSolarPanelBlock::new);


    protected HVSolarPanelBlock(Settings settings) {
